...
import { Background } from '@/app/chat/[id]/page.style';
import { Bold, ButtonContainer, Detail, GlobalStyle, View } from '@/app/boom/page.style';
import { Announce, Logo, TimerContainer } from './WaitingPage.styled';
                ...
                <View>
                    ...
                    <Detail>
                        <div className="desc_text">
                            <Bold>채팅방이<br /><span style={{color:'#3072FF'}}>{Math.floor(timeRemaining/6000)>0 ? Math.floor(timeRemaining/6000) : 0}분 뒤</span>에 열립니다!</Bold>
